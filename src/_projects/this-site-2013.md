...
- Automating FTP uploads with [WinSCP](http://winscp.net/), later [auto-deploy with SSH from CI]({% post_url 2020-02-26-setting-up-ci-for-this-site-with-bitbucket-pipelines-and-ssh %})
