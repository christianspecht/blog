        ...
        <div class="span3">
          ...
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li><a href="${bf.util.site_path_helper('simpleleague')}" rel="tooltip" title="Minimalistic tool to display tabular league data (results, rankings etc.) in existing websites.">SimpleLeague</a></li>
          ...
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li><a href="https://www.ohloh.net/accounts/131837?ref=Detailed" rel="tooltip" title="Ohloh profile for Christian Specht"><img alt="Ohloh profile for Christian Specht" title="Ohloh profile for Christian Specht" height="35" src="http://www.ohloh.net/accounts/131837/widgets/account_detailed.gif" width="191" /></a></li>
            </ul>
          </div><!--/.well -->
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
